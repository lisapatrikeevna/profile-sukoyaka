...
import cl from './AuthMainPage.module.css'
import {
    Container,
    Grid,
    Button,
            ...
            <Container maxWidth="sm">
                ...
                <Dialog open={open} onClose={handleClose}
                    ...
                    <DialogContent className={cl.dialogWrapStyle}>
                        ...
                        <DialogContentText
                            className={[cl.dialogContentWrapStyle, cl.dialogContentWrapStyle1].join(' ')}>
                            <Typography className={cl.dialogContentTextStyle}>
                                ゲームでコインをGETして、
                                <br/>
                                パワーアップItemをこうにゅう！
                        ...
                        <DialogContentText
                            className={[cl.dialogContentWrapStyle, cl.dialogContentWrapStyle2].join(' ')}>
                            <Typography className={cl.dialogContentTextStyle}>
                                かわいい動物達を仲間にして、
                                <br/>
                                バーチャルファームを作りましょう！
